...
(function(d){d.fn.justifiedGallery=function(r){function n(b,i){return'<div className="jg-error '+i+'"style="">'+b+"</div>"}function o(b,i,j){d(b).find(".jg-loading").fadeOut(500,function(){d(this).remove();p(d,b,i,0,j);d.isFunction(j.onComplete)&&j.onComplete.call(this,b)})}function q(b,i,d,c){var a,h=0,g;for(a=0;a<b.length;a++){b[a].nh=Math.ceil(i[b[a].indx].height*((i[b[a].indx].width+d)/i[b[a].indx].width));b[a].nw=i[b[a].indx].width+d;var e=b[a],f=b[a].nw,m=b[a].nh,l=void 0,l=f>m?f:m;e.suffix=100>=
l?c.sizeRangeSuffixes.lt100:240>=l?c.sizeRangeSuffixes.lt240:320>=l?c.sizeRangeSuffixes.lt320:500>=l?c.sizeRangeSuffixes.lt500:640>=l?c.sizeRangeSuffixes.lt640:c.sizeRangeSuffixes.lt1024;b[a].l=h;c.fixedHeight||(0==a?g=b[a].nh:g>b[a].nh&&(g=b[a].nh));h+=b[a].nw+c.margins}c.fixedHeight&&(g=c.rowHeight);d="";for(a=0;a<b.length;a++)h=i[b[a].indx],e=b[a].nh,f=void 0,f='<div className="jg-image" style="left:'+b[a].l+'px">',f+=' <a href="'+h.href+'" ',"undefined"!=typeof h.rel&&(f+='rel="'+h.rel+'"'),"undefined"!=
typeof h.target&&(f+='target="'+h.target+'"'),f+='title="'+h.title+'">',f+='  <img alt="'+h.alt+'" src="'+h.src+b[a].suffix+h.extension+'"',f+='style="width: '+b[a].nw+"px; height: "+e+'px;">',c.captions&&(f+='  <div style="bottom:'+(e-g)+'px;" className="jg-image-label">'+h.alt+"</div>"),f+=" </a></div>",d+=f;return'<div className="jg-row" style="height: '+g+"px; margin-bottom:"+c.margins+'px;">'+d+"</div>"}function p(b,d,e,c,a){var c=[],h,g,k=0,f=b(d).width();for(h=g=0;g<e.length;g++)null!=e[g]&&(k+e[g].width+
...
lt240:"_m",lt320:"_n",lt500:"",lt640:"_z",lt1024:"_b"},rowHeight:120,margins:1,justifyLastRow:!0,fixedHeight:!1,captions:!0,rel:null,target:null,extension:/\.[^.]+$/,refreshTime:500,onComplete:null},r);return this.each(function(b,i){d(i).addClass("justifiedGallery");var j=0,c=Array(d(i).find("img").length);0!=c.length&&(d(i).append('<div className="jg-loading"><div className="jg-loading-img"></div></div>'),d(i).find("a").each(function(a,b){var g=d(b).find("img");c[a]=Array(5);c[a].src="undefined"!=typeof d(g).data("safe-src")?
